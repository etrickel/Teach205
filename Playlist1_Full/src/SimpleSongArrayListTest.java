...
class SimpleSimpleSongArrayListTest {
    ...
    void add() throws FileNotFoundException {
        SimpleSongArrayList songList = new SimpleSongArrayList(TEST_INPUT_FILE);
    ...
    /**
     * This method tests the set() method of the SimpleSongArrayList class. It changs the song at a
    ...
    /**
     * This method tests the delete() method of the SimpleSongArrayList class. It deletes a song at a
    ...
    /**
     * This method tests the toString() method of the SimpleSongArrayList class. It checks if the string
